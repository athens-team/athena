...
import static net.rothlee.athens.leveldb.SampleTest.DBState.FRESH;
import static net.rothlee.athens.leveldb.SampleTest.Order.SEQUENTIAL;
...
public class SampleTest
{
    ...
    public SampleTest(Map<Flag, Object> flags) throws Exception
    {
        ClassLoader cl = SampleTest.class.getClassLoader();

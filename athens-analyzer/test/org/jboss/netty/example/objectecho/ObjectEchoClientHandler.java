...
/**
 * Handler implementation for the object echo client. It itiates the ping-pong
 * traffic between the object echo client and server by nding the first message
 * to the server.
 */
public class ObjectEchoClientHandler extends SimpleChannelUpstreamHandler {
	...
	public ObjectEchoClientHandler(int firstMessageSize) {
		if (firstMessageSize <= 0) { throw new IllegalArgumentException(
	...
	public void channelConnected(ChannelHandlerContext ctx, ChannelStateEvent e) {
		// Send the first message if this handler is a client-side ndler.
